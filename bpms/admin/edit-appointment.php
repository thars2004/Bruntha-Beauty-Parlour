...
<html>
<head>
<title>Appoinment And Service Management System-Bruntha Beauty Parlour-Thisaiyanvilai || Update Appointment</title>
...
<tr>
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" >
     <option value="1" select="true">Selected</option>
