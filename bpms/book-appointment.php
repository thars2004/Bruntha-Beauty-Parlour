...
<html lang="en">
  <head>
    ...
    <title>Appoinment And Service Management System-Bruntha Beauty Parlour-Thisaiyanvilai | Appointment Page</title>
                ...
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        <div style="padding-top: 30px;">
                            ...
                            <input type="date" class="form-control appointment_date" placeholder="Date" name="adate" id='adate' onChange="getDay(this.value);" min="<?php echo date('Y-m-d');?>" max="<?php echo date('Y-m-d',strtotime('+182 day'));?>" required="true"></div>
                        <div style="padding-top: 30px;">
