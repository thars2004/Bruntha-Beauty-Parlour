...
?>
              <li>
                <span class="fa fa-map-marker"></span> <p><a href="http://maps.app.goo.gl/pQonJgycastt27Ft5"> <?php  echo $row['PageDescription'];?>.</a></p>
              </li>
              <li><span class="fa fa-phone"></span><a href="tel:+7-800-999-800"> +91 <?php  echo $row['MobileNumber'];?></a></li>
  ...
  <section class="w3l-footer-29-main w3l-copyright">
    <div class="container">
      <div class="row bottom-copies">
        <p class="col-lg-8 copy-footer-29">© Bruntha Beauty Parlour </p>
