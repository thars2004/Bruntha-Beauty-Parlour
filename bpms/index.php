...
<html lang="en">
  <head>
    ...
    <title>Appoinment And Service Management System-Bruntha Beauty Parlour-Thisaiyanvilai | Home Page</title>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">Our Parlour is Most Popular</h4>
                            <p class="para ">Eline Hair and Beauty Parlour Offers - Beauty Services</p>
